...
def FP_NF_MIMIC(df, diseases, category, category_name, seed=19):
    ...
    for i in range(len(FP_total)):
        ...
        if category_name == 'insurance':
            ...
            if i == 2:
                ...
                # insurance_FPR[f"Seed_{seed}"] = FPR_Ins

                print(f'============FPR for insurance done ==============')
                return FPR_Ins
...
def FP_NF_MIMIC_Two_Group_Inter(df, diseases, category1, category_name1, category2, category_name2, seed=19):
