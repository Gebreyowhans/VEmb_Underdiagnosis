...
def main():
    ...
    # import from CheXpert
    from CheXpert.FPR import FP_NF_CheXpert, FP_NF_CheXpert_Inter, FiveRunSubgroup, FiveRunTwoGroup
    from CheXpert.CheXpert_Biomedclip_Training import training_and_evaluation, calculate_avg_aucs, make_dataset
    ...
    df_MIMIC = df_MIMIC[~df_MIMIC['emb'].apply(
