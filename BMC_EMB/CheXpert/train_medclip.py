...
metas = [
    # "race-bin", "race-cls", "gender","age_decile", "insurance",
    "disease"]


mimic_jpg_folder = os.path.join(root_dir, "data", "mimic-jpg")
medclip_embedding_folder = os.path.join(root_dir, "data", "medclip-embedding")
medclip_embedding_path = os.path.join(
    medclip_embedding_folder, "embedding_from_medclip.pkl")
train_test_idx_path_medclip = os.path.join(
    medclip_embedding_folder, "train_test_idx.pkl")
...
for metadata in metas:
    data_folder = os.path.join(root_dir, "data", "medclip-embedding", metadata)
    models_folder = os.path.join(
        root_dir, "models", "medclip-embedding", metadata)
    figures_folder = os.path.join(
        root_dir, "fig", "medclip-embedding", f"predict-{metadata}")
    ...
    if os.path.exists(train_dataset_path):
        ...
        if os.path.exists(medclip_embedding_path):
            ...
            model_path = os.path.join(
                root_dir, 'pretrained', 'medclip-vit', 'pytorch_model.bin')
            device = torch.device(
