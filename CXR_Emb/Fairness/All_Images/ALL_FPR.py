...
def main():
  ...
  for seed in seeds:
    ...
    three_group_intersection_path = "./FPR/Three_Group_Intersection_FPR/"
    os.makedirs(os.path.dirname(three_group_intersection_path), exist_ok=True)
